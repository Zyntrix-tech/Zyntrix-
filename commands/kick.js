        ...
        try {
            ...
            if (!jid.endsWith("@g.us")) {
                ...
                return sock.sendMessage(jid, { 
                    text: "Γ¥î This command only works in groups!\n\nJoin a group chat and try again.", 
                    contextInfo 
                }, { quoted: msg });
            }
            ...
            if (!senderIsAdmin && !isOwner) {
                const contextInfo = createForwardedContext();
                return sock.sendMessage(jid, { 
                    text: "Γ¢ö Only group admins can kick members!\n\nAsk a group admin to help you.", 
                    contextInfo 
                }, { quoted: msg });
            }
            ...
            if (!isOwnerAndAdmin && !botIsAdmin && !ownerIsAdmin) {
                const contextInfo = createForwardedContext();
                return sock.sendMessage(jid, { 
                    text: "ΓÜá∩╕Å I need admin rights to kick members!\n\nPlease make me an admin first.", 
                    contextInfo 
                }, { quoted: msg });
            }
            ...
            await sock.sendMessage(jid, {
                text: `Γ£à Successfully kicked @${target.split("@")[0]} from the group!`,
                mentions: [target],
                contextInfo
            });
        } catch (err) {
            ...
            await sock.sendMessage(msg.key.remoteJid, {
                text: "Γ¥î Failed to kick user!\n\nPossible reasons:\nΓÇó User is the group owner\nΓÇó Bot lacks admin rights\nΓÇó User already left the group",
                contextInfo
            }, { quoted: msg });
        }
    }
