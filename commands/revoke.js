    ...
    async execute(sock, msg, args = []) {
        ...
        try {
            ...
            if (!isSenderAdmin && !isOwner) {
                await sock.sendMessage(jid, { 
                    text: "≡ƒöù Only admins can revoke the invite link!" 
                }, { quoted: msg });
                return;
            }
            ...
            if (!isBotAdmin) {
                await sock.sendMessage(jid, { 
                    text: "≡ƒöù I need admin rights to revoke the invite link!" 
                }, { quoted: msg });
                return;
            }
            ...
            await sock.sendMessage(jid, { 
                text: `≡ƒöù *INVITE LINK REVOKED*\n\nΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n\n` +
                      `Γ£à Old link has been invalidated!\n\n` +
                      `≡ƒô¢ Group: ${metadata.subject}\n\n` +
                      `≡ƒöù *New Link:* ${newInviteLink}\n\n` +
                      `ΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n\n` +
                      `ΓÜá∩╕Å Share the new link with members who need to join!`,
                contextInfo 
            }, { quoted: msg });
            ...
            await sock.sendMessage(jid, { 
                text: "Γ¥î Failed to revoke invite link. Make sure I'm an admin!" 
            }, { quoted: msg });
        }
    }
};
