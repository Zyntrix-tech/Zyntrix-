...
module.exports = {
    ...
    async execute(sock, msg, args) {
        ...
        try {
            ...
            const text = `≡ƒîì *TIME IN ${response.data.timezone.toUpperCase()}*\n\n` +
                         `≡ƒòÉ Time: *${time}*\n` +
                         `≡ƒôà Date: ${date}\n` +
                         `≡ƒîà UTC Offset: ${response.data.utc_offset}`;
