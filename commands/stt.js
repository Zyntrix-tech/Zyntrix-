...
module.exports = {
    ...
    async execute(sock, msg, args) {
        ...
        try {
            // Send reaction
            await sock.sendMessage(from, { react: { text: '≡ƒÄñ', key: msg.key } });
            
            // Send processing message
            const contextInfo = createForwardedContext();
            await sock.sendMessage(from, { 
                text: "≡ƒÄñ Transcribing... Please wait...", 
                contextInfo 
            }, { quoted: msg });
            ...
            const contextInfo = createForwardedContext();
            await sock.sendMessage(from, { 
                text: "Γ¥î Failed to transcribe. Please try again with a clearer voice note.", 
                contextInfo 
            }, { quoted: msg });
        }
    }
