...
module.exports = {
    ...
    async execute(sock, msg, args = []) {
        ...
        if (!tweetContent) {
            ...
            await sock.sendMessage(from, { 
                text: "≡ƒÉª *POST TWEET (API)*\n\nΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n\nUsage: !tweet2 <your_tweet>\n\nExample:\n!tweet2 Hello from WhatsApp! ≡ƒÉª\n\nΓÜá∩╕Å Requires Twitter API credentials in .env",
                contextInfo 
            }, { quoted: msg });
            return;
        }
        ...
        if (!TWITTER_BEARER_TOKEN) {
            ...
            await sock.sendMessage(from, { 
                text: `≡ƒÉª *TWEET (SIMULATED)*\n\nΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n\nΓÜá∩╕Å Twitter API not configured.\n\nΓ£à Your tweet has been recorded (simulated):\n\n≡ƒô¥ "${tweetContent}"\n\nΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n\n≡ƒòÉ Time: ${new Date().toLocaleString()}\n\n≡ƒÆí To post real tweets, add these to .env:\nTWITTER_BEARER_TOKEN=your_token`,
                contextInfo 
            }, { quoted: msg });
            return;
        }
        ...
        try {
            ...
            if (response.ok) {
                ...
                await sock.sendMessage(from, { 
                    text: `≡ƒÉª *TWEET POSTED SUCCESSFULLY!*\n\nΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n\nΓ£à Your tweet has been posted to Twitter!\n\n≡ƒô¥ "${tweetContent}"\n\n≡ƒöù https://twitter.com/user/status/${data.data.id}\n\nΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n\n≡ƒòÉ Time: ${new Date().toLocaleString()}`,
                    contextInfo 
                }, { quoted: msg });
            } else {
            ...
            await sock.sendMessage(from, { 
                text: `≡ƒÉª *TWEET FAILED*\n\nΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n\nΓ¥î Failed to post tweet: ${err.message}\n\n≡ƒô¥ Your tweet was:\n"${tweetContent}"\n\nΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n\n≡ƒÆí Check your Twitter API credentials in .env`,
                contextInfo 
            }, { quoted: msg });
        }
    }
