...
module.exports = {
    ...
    async execute(sock, msg, args = []) {
        ...
        try {
            ...
            const contextInfo = createForwardedContext();
            await sock.sendMessage(from, {
                text: `≡ƒô▒ *WhatsApp Pairing Code*\n\nNumber: ${fullNumber}\n\n≡ƒöó *Code:* ${formatted}\n\nΓÅ░ This code expires in 60 seconds!\n\n≡ƒôî *How to link:*\n1. Open WhatsApp on your phone\n2. Go to Linked Devices\n3. Tap "Link with phone number"\n4. Enter the code above\n\nΓ£¿ Enjoy using Nexora on multiple devices!`,
                contextInfo
            }, { quoted: msg });
        } catch (err) {
            ...
            const contextInfo = createForwardedContext();
            await sock.sendMessage(from, {
                text: "Γ¥î Failed to generate pairing code!\n\nPossible reasons:\nΓÇó Bot is already linked to maximum devices\nΓÇó Invalid phone number format\nΓÇó WhatsApp server issue\n\nPlease try again or use a different number.",
                contextInfo
            }, { quoted: msg });
        }
    }
