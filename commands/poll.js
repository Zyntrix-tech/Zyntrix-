    ...
    async execute(sock, msg, args = []) {
        ...
        if (!jid.endsWith("@g.us")) {
            await sock.sendMessage(jid, { 
                text: "≡ƒôè Polls can only be created in groups!" 
            }, { quoted: msg });
            return;
        }
        ...
        if (options.length < 2) {
            await sock.sendMessage(jid, { 
                text: "Γ¥î Please provide at least 2 options!" 
            }, { quoted: msg });
            return;
        }
        ...
        await sock.sendMessage(jid, { 
            text: `≡ƒôè *POLL CREATED*\n\nΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n\nΓ¥ô *Question:* ${question}\n\n${optionsList}\n\nΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n\n≡ƒÆ¼ Vote by replying with your choice number!`,
            contextInfo 
        }, { quoted: msg });
    }
};
