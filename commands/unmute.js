    ...
    async execute(sock, msg, args = []) {
        ...
        if (!jid.endsWith("@g.us")) {
            await sock.sendMessage(jid, { 
                text: "≡ƒöè This command only works in groups!" 
            }, { quoted: msg });
            return;
        }
        ...
        try {
            ...
            if (!isAdmin && !isOwner) {
                await sock.sendMessage(jid, { 
                    text: "≡ƒöè Only admins can use this command!" 
                }, { quoted: msg });
                return;
            }
            ...
            if (!isOwnerAndAdmin && !botAdmin) {
                await sock.sendMessage(jid, { 
                    text: "≡ƒöè I need admin rights to unmute the group!" 
                }, { quoted: msg });
                return;
            }
            ...
            await sock.sendMessage(jid, { 
                text: "Γ¥î Failed to unmute the group. Make sure I'm an admin!" 
            }, { quoted: msg });
        }
    }
};
