...
module.exports = {
    ...
    async execute(sock, msg, args = []) {
        ...
        await sock.sendMessage(from, { 
            text: `≡ƒô╕ *PROFILE PICTURE COPIED!*\n\nΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n\n≡ƒæñ *Target:* ${targetName}\n\n≡ƒôÑ *Profile saved to gallery!*\n\nΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n\n≡ƒÆí *Note:* This is just a fun simulation!\n\nUse !wasted on someone to add the wasted effect!`,
            contextInfo 
        }, { quoted: msg });
