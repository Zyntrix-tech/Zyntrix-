...
module.exports = {
    ...
    async execute(sock, msg, args = []) {
        ...
        if (!prompt) {
            const contextInfo = createForwardedContext();
            await sock.sendMessage(from, { text: "Usage: !ai or .ai <your question>", contextInfo }, { quoted: msg });
            return;
        }
        ...
        try {
            ...
            const res = await client.chat.completions.create({
                model: "gpt-4o-mini",
                messages: [
                    { role: "system", content: "You are Nexora AI, a helpful and intelligent AI assistant created by Emmanuel Restoration Abimbola. Provide accurate, helpful, and engaging responses. Be concise but informative." },
