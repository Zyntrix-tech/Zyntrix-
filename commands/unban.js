...
module.exports = {
    ...
    async execute(sock, msg, args = []) {
        ...
        try {
            ...
            if (!isAdmin && !isOwner) {
                await sock.sendMessage(jid, { 
                    text: "Γ¥î Only admins can use this command!" 
                }, { quoted: msg });
                return;
            }
            ...
            await sock.sendMessage(jid, { 
                text: "Γ¥î Failed to unban user. The user might not be in the ban list or I'm not an admin!" 
            }, { quoted: msg });
        }
    }
};
